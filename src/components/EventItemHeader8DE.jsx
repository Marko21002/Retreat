...
export function EventItemHeader8DE() {
  return (
    <section id="relume" className="relative px-[5%] py-20 md:py-28 lg:py-32">
      <div className="relative z-10 container">
        <div className="mx-auto flex w-full max-w-xl md:max-w-2xl flex-col items-center text-center text-white">
          <div className="flex flex-col items-center">
            <h4 className="font-serif text-[#d4b98c] tracking-widest uppercase text-sm md:text-base">Exklusive Veranstaltungsortvermietung</h4>
            ...
            <h1 className="mt-3 text-4xl sm:text-5xl font-serif font-bold md:mt-4 md:text-7xl lg:text-8xl tracking-wide">
              Historisches Schloss für Ihre Events
            </h1>
          </div>
          <p className="mt-6 text-sm sm:text-base md:mt-7 md:text-lg font-sans leading-relaxed text-white/90">
            Schloss Thalheim bietet eine luxuriöse historische Location für private Veranstaltungen, 
            Firmenretreats und Wellness-Events. Buchen Sie dieses exklusive Schloss und seine 
            Anlagen für ein unvergessliches Erlebnis mit erstklassigen Annehmlichkeiten und 
      ...
      <div className="absolute inset-0 z-0">
        <img
          ...
          alt="Schloss Thalheim Luxuriöses Schloss"
        />
