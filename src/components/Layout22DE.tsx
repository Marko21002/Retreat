...
export type Layout22DEProps = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout22DE = (props: Layout22DEProps) => {
...
export const Layout22DEDefaults: Props = {
  heading: "Luxuriöse Unterkünfte",
  description:
    "Erleben Sie unvergleichlichen Komfort in unseren elegant gestalteten Gästezimmern. Jede Unterkunft bietet eine perfekte Mischung aus historischem Charme und modernen Annehmlichkeiten und schafft so einen Ort der Ruhe für unsere Gäste. Ob Sie einen Retreat planen, an einer Hochzeit teilnehmen oder eine Firmenveranstaltung organisieren - unsere vielfältigen Zimmeroptionen garantieren, dass jeder seinen perfekten Raum findet.",
  buttons: [
    { title: "Alle Zimmer anzeigen", variant: "primary" as const },
    {
      title: "Mehr erfahren",
  ...
  image: {
    src: "/room.jpeg",
    alt: "Luxuriöses Gästezimmer im Schloss Thalheim",
  },
}; 